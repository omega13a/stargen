...
long double gas_radius_1Gyr_875K_25core_mass(long double total_earth_masses, planet *the_planet)
{
  ...
  else if (total_earth_masses < 2154.0)
  {
    ...
    jupiter_radii1 = planet_radius_helper(total_earth_masses, 774.0, mass_radii[774], 1292.0, mass_radii[1292], 2154.0, mass_radii[2154]);
    jupiter_radii2 = planet_radius_helper(total_earth_masses, 1292.0, mass_radii[1292], 2154.0, mass_radii[2154], 3594.0, mass_radii[3593]);
    jupiter_radii = rangeAdjust(total_earth_masses, jupiter_radii1, jupiter_radii2, 1292.0, 2154.0);
  }
  else if (total_earth_masses < 3594.0)
  {
...
long double gas_radius_1Gyr_875K(long double core_earth_masses, long double total_earth_masses, planet *the_planet)
{
  ...
  long double jupiter_radii2 = 0.0;
  map<int, long double> core_mass_radii;
  core_mass_radii[0] = gas_radius_1Gyr_875K_0core_mass(total_earth_masses, the_planet);
  core_mass_radii[10] = gas_radius_1Gyr_875K_10core_mass(total_earth_masses, the_planet);
  core_mass_radii[25] = gas_radius_1Gyr_875K_25core_mass(total_earth_masses, the_planet);
  core_mass_radii[50] = gas_radius_1Gyr_875K_50core_mass(total_earth_masses, the_planet);
